 ...
 * Fixes: removed amounts, internal tabling, saving as custom product.
 */
global $wcpb_backend;
				...
				<div id="postbox-container-1" class="postbox-container">
					<div id="normal-sortables" class="meta-box-sortables ui-sortable">
						...
						<div id="wcpb-product_cat" class="wcpb-admin-postbox postbox">
							...
							<!--		<tr>
										<td><label for="wcpb-currency-symbol">< ?php _e( 'Currency Symbol (needs removing, Woo sorts this)', 'wcpb' ); ?></label></td>
