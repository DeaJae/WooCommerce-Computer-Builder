...
<div id="wcpb-config-wrapper">
	...
	<div id="wcpb-config-review">
		...
		<!--< ?php do_action( 'wcpb_include_template', 'templates/wcpb-review-attribute.php' ); ?> / Doesn't do anything currently--> 
		<!-- Option Lists -->
		...
		<!--< ?php do_action( 'wcpb_include_template', 'templates/wcpb-review-cart.php' ); ?> </!--disabled for sidebar cart-->
	</div>
