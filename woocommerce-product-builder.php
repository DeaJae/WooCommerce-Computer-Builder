 ...
 * Author URI: https://github.com/philippjbauer | https://github.com/deajae
 *
 * Text Domain: wcpb
 ...
 * @version 0.9
 * Fixes by Darren Jermy: removed Admin export pages (not needed with cart based)
 */
...
if ( ! class_exists( 'WC_Product_Builder' ) && $bool_woocommerce_active ) {
	...
	class WC_Product_Builder {
		 ...
		 * @return float (not needed for cart based)
		 */
		 ...
		 * @param  array $args (not needed for cart based)
		 * @return void
		 */
 ...
 /*
 * AJAX cart in review-cart
 *
 *
 */
#apply_filter('add_to_cart_fragments', 'woocommerce_header_add_to_cart_fragment');
